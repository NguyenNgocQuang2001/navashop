    ...
    return (
        <>
            ...
            <Routes>
                ...
                <Route path="/products/:category" element={<AllProduct products={products}/>} />
                <Route path="/products/:category/:subCategory" element={<AllProduct products={products}/>} />
                ...
                <Route path="/admin/managerorder" element={<AdminManagerOrder />} />
                <Route path="/admin/managerhistory" element={<AdminHistory />} />
            </Routes>
            <Footer />
        </>
    )
